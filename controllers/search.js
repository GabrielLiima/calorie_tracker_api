  ...
  axios
    ...
    .then((response) => {
      const meal = {
        ...
        calories: response.data.nutrition.nutrients[14].amount,
        protein: response.data.nutrition.nutrients[2].amount,
        carbs: response.data.nutrition.nutrients[0].amount,
        fat: response.data.nutrition.nutrients[3].amount,
        percentProtein: response.data.nutrition.caloricBreakdown.percentProtein,
        percentCarbs: response.data.nutrition.caloricBreakdown.percentCarbs,
        percentFat: response.data.nutrition.caloricBreakdown.percentFat,
      }
